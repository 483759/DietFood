...
<body class="is-preload">
	...
	<div id="main">
		...
		<table>
			...
			String sql = "select i.*, im.igd_img from ingredient i join igdimg im on i.igd_num=im.igd_num join recommend r on i.igd_num=r.igd_num where usr_num=?;"; 
					//해당 유저의 추천 재료 목록 및 사진을 불러오기 위한 쿼리문
		...
		<table>
			...
			String sql2 = "select f.*, fm.fd_img from food f join construction c on f.fd_num=c.fd_num join ingredient i on c.igd_num=i.igd_num join recommend r on i.igd_num=r.igd_num join foodimg fm on f.fd_num=fm.fd_num where usr_num=?;"; 
			...
			while(rs2.next()){
				String fd_name = rs2.getString("fd_name");
				String fd_dsc = rs2.getString("fd_dsc");
				String fd_img = rs2.getString("fd_img");
				out.println("<tr>");
