...
<body class="is-preload">
	<%
		...
		String sql = "select * from health where usr_num = ?"; 
		//이미 저장된 유저의 건강상태 정보가 있는지 확인하기 위한 쿼리문
	...
	<div id="main" style="margin-top: -100px;">
		<form name="condition" method="post" action="condition.jsp">
			...
			<c:if test="${isNull==0}">
				...
				<table id="main_table">
					...
					<tr>
						<td>Height</td>
						<td><input type="number" name="height" id="text_box"
							background-color="#7F7F7F" value="<%=height%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Weight
						<td><input type="number" name="weight" id="text_box"
							value="<%=weight%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Sugar_lv(Empty stomach)</td>
						<td><input type="number" name="sugar" id="text_box"
							value="<%=sugar%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Body_fat(Percentage)</td>
						<td><input type="number" name="body_fat" id="text_box"
							value="<%=fat%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Max_Blood_pressure</td>
						<td><input type="number" name="max_blood_pressure"
							id="text_box" value="<%=maxbp%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Min_Blood_pressure</td>
						<td><input type="number" name="min_blood_pressure"
							id="text_box" value="<%=minbp%>" required /> <br /></td>
					</tr>
					<tr>
						<td>Cholesterol(mg/dL)</td>
						<td><input type="number" name="cholesterol" id="text_box"
							value="<%=cholesterol%>" required /> <br /></td>
					</tr>
